...
namespace ConstructionLine.CodingChallenge.Tests
{
    public class SearchEngineTestsBase
    {
        protected static void AssertResults(List<Shirt> shirts, SearchOptions options)
        {
            ...
            {
                Assert.That(sizeIds.Contains(shirt.Size.Id)
        ...
        protected static void AssertValidSearchOptions(SearchOptions searchOptions)
        {
            Assert.That(searchOptions, Is.Not.Null);
            Assert.That(searchOptions.Sizes.Any() && searchOptions.Colors.Any(),
                    $"Search Options Count for Color showing '{searchOptions.Colors.Count()}' and Size showing '{searchOptions.Sizes.Count()}'. Both should have at least 1'");
        }
            ...
            foreach (var size in Size.All)
            {
                ...
                var expectedSizeCount = shirts
                    .Count(s => s.Size.Id == size.Id
                                ...
                                && searchOptions.Sizes.Contains(size));
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(c => c.Color.Id == color.Id
                                ...
                                && searchOptions.Colors.Contains(color));
